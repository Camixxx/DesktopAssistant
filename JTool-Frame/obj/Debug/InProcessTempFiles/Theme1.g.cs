...
namespace JTool_Frame.ColorLib {
    ...
    public partial class Theme1 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Theme1).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Theme1));
        ...
        private string FindResource() {
            string[] resources = typeof(Theme1).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Theme1.g.xaml") || resource.Equals("Theme1.g.xaml"))) {
                    return resource;
                }
            }
